...
объем выбросов составляет [830 миллионов тонн CO<sub>2</sub>][4] в год, что 
...
[40 процентов всего углеродного следа от интернета][7]. Этот объем мог бы быть 
...
Хорошая новость в том, что у нас есть нескольсо способов исправить 
растолстевшие сайты и постоянно бороться с углеродным следом нашей отрасли — 
способы, которые отлично сочетаются с хорошей бизнес-практикой: веб-разработка 
...
страницы и углеродном следе. К сожалению, определение углеродного следа сайта, 
в лучешм случае, получается неоднозначным и неточным. Вот, что я думаю по этому 
поводу:

* Исследование [Национальной лаборатории Лоренса Беркли (Lawrence Berkeley 
National Laboratory)][8] 2008 года говорит, что для передачи 1 ГБ требуется 
[13 кВт⋅ч][9].
...
* Если мы умножим 13 кВт⋅ч на 1,2 фунта, то получим 15,6 функтов (7,08 кг) 
...
данных.
* При 15,6 фунтах на гигабайте мы получаем более 10 тонн CO<sub>2</sub>e. 
* Передача данных через мобильные сети, с учетом [3G/4G][13], практически в 5 
раз больше загрязняет окружающую среду — 77 фунтов (34,93 кг) CO<sub>2</sub> 
на гигабайт.
...
с 183 миллионами просмотров страниц в день, примерно 10% которых — с мобильных 
устройств, потенциально несет ответственность за выброс 2600 тонн 
...
С чего начать? С нашего дизайна.
...
расширенного функционала социального взаимодействия и использования различных
дизайнерских фишечек и рюшечек, и все это приводит к увеличению размера
страницы. Лучший способ не допустить этого — это заранее [ограничить
ресурсы][20]: начать с желаемого размера страницы и стремиться сохранить его.
...
страницы за [2 или менее секунды][22]. Само собой, чем больше веса страницы мы 
...
грубом приближении суммарный трафик сайта, не забывая выделять отдельно более 
загрязняющий мобильный трафик и кешированные данные.
...
аудитории и в то же время ограничение размера.
...
отказаться от использования требовательных к ресурсам функций сайта. Вездесущие
карусели — первое, на что стоит обратить внимание. Обычная карусель содержит от
3 до 6 изображений, плюс JavaScript, необходимый для ее анимации, обычно
добавляющий до нескольких сотен килобайт. 
...
внимание на [Вызов каруселям от Брэда Фроста (Brad Frost)][25]. Другие кандидаты 
на удаление — кнопки публикации в социальные сети, встроенные карты, видео с 
автоматическим воспроизведением, Flash-контент, рекламные баннеры а также 
встраиваемый контент, предоставляемый третьими лицами — все они требуют загрузки 
большого объема вспомогательных данных.

**Графический дизайн:** Изображения вносят самый большой вклад в углеродный 
след большинства сайтов (в среднем, 60%), и за счет них мы можем уменьшить 
объем данных сайта. Для начала определите, может быть вы можете обойтись меньшим 
количеством изображений? Кроме того, иногие изображения в вебе сохранены в 
...
уменьшить число HTTP-запросов. Чтобы распробовать это, попробуйте использовать 
инструмент [Google Page Speed][31] на вашем сайте, и он покажет, какие техники 
вы можете применить, чтобы ускорить его. Если вы хотите более подробно изучить 
этот вопрос, я рекомендую прочесть статью 
«[Производительность в вебе. Часть 1][32]» или 
[недавнюю статью Лара Свонсон (Lara Swanson) на ALA][33]. 
...
пользователься преимуществами дешевой геотермальной энергии. В настоящее время 
экологичный хостинг, может быть, подойдет не для всех (он может быть более 
дорогим, а Исландия может быть достаточно далеко от ваших клиентов), но со 
...
**Остаточная компенсация:** Даже после приминения минималистичного дизайна, 
оптимизации и переезда на экологичный хостинг, за вашим сайтом все еще тянется 
углеродный след. Чтобы снять с себя ответственность за это, вы можете оплатить 
компенсацию, которая, как правило, составляет $19 за тонну 
[в зависимости от проекта][36]. Компенсация не очищает атмосферу от 
CO<sub>2</sub>, и это очень плохая альтернатива снижению выбросов. Тем не менее, 
многие программы представляют дополнительные преимещества, такие как 
...
* Сервисы краткосрочной аренды снижают количество автомобилей на дороге — 
...
что приводит к снижению потребление.

Мы продолжаем предпринимать шаги по улучшению онлайн-экономии. Тем не менее, 
нам скоро предстоит встречать [5 миллиардов новых пользователей][40] интернета. 
Так как суммарное влияние интернета на загрязнение окружающей среды продолжает 
расти, ответственность за климат лежит на тех, кто занимается развитием этой 
отрасли. Но разрабатывая экологичные ресурсы, мы можем снизить влияние интернета 
на окружающую среду, удовлетворяя потребности пользователей и увеличивая 
прибыльность бизнеса.

Возможно, мы считаем, что экологичные решения всегда требуют от нас пойти на 
какие-либо жертвы, но в случае с веб это не так. Сайты могут быть экологичнее, 
